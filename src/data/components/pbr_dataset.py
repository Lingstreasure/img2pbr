...
class PBROvercastHdrRenderDataset(Dataset):
    """PBR maps dataset with overcast-HDR-rendering images."""
    ...
    def __init__(
        ...
        pbr_dir_names: List[str],
        rendered_dir_names: List[str],
        mode: str = "train",
    ...
    def _preprocess(self) -> List[List[Any]]:
        ...
        for dataset_name, pbr_dir_name, rendered_dir_name in zip(
            ...
            for name in sample_names:
                ...
                gt = np.concatenate([gts["albedo"], gts["normal"], gts["roughness"]], axis=-1)
