...
class MatMatchingDataModule(LightningDataModule):
    """`LightningDataModule` for Material Matching dataset.
    ...
    def __init__(
        ...
        """Initialize a `MatMatchingDataModule`.
    ...
    def num_classes(self) -> int:
        ...
        :return: The number of material classes (10).
        """
        return 10
